<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="StatusCode.ascx.cs" Inherits="VS.ECommerce_MVC.cms.Admin.Redirect301.StatusCode" %>
                            ...
                            <div class="row-fluid">
                                <div class="span12">
                                    <div class="dataTables_length" id="sample_1_length">
                                        <asp:FileUpload ID="FileUpload1"  CssClass="vadd toolbar btn btn-info"  style=" float:left; margin-right:10px" runat="server" />
                                        <asp:Button ID="Button1"  CssClass="vadd toolbar btn btn-info" runat="server" style="  margin-right:10px"  OnClick="Button1_Click" Text="Import Exel" />
                                        <div style=" clear:both"></div>
