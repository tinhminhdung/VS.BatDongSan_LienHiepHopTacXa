<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MNews.ascx.cs" Inherits="VS.ECommerce_MVC.cms.Admin.M_News.MNews" %>
                            ...
                            <tr class="odd gradeX">
                                <td class="hidden-phone">
                                 ...
                                 <td style="text-align:center"  class="Imgsmall">
                                    <a title="<%#Eval("Title")%>"  target=_blank href="/tin-tuc/<%#Eval("TangName")%>.html"><%#MoreAll.MoreImage.Image(Eval("ImagesSmall").ToString())%></a>
                              ...
                              <td style="text-align:center">
                                  <a href="#" class="ChangeNewsStatus active action-link-button" data-id="<%#(Eval("inid").ToString()) %>"><%#MoreAll.MoreAll.Enable(DataBinder.Eval(Container.DataItem, "Status").ToString())%></a>
                               ...
                               <td style="text-align:center">
                                    <a href="#" class="ChangeNewsHome active action-link-button" data-id="<%#(Eval("inid").ToString()) %>"><%#MoreAll.MoreAll.Enable(DataBinder.Eval(Container.DataItem, "new").ToString())%></a>
                                 ...
                                 <td style="text-align:center">
                                  <a href="#" class="ChangeNewsCheckBox1 active action-link-button" data-id="<%#(Eval("inid").ToString()) %>"><%#MoreAll.MoreAll.Enable(DataBinder.Eval(Container.DataItem, "CheckBox1").ToString())%></a>
                                </td>
                                 <td style="text-align:center">
                                  <a href="#" class="ChangeNewsCheckBox2 active action-link-button" data-id="<%#(Eval("inid").ToString()) %>"><%#MoreAll.MoreAll.Enable(DataBinder.Eval(Container.DataItem, "CheckBox2").ToString())%></a>
                                </td>
                        ...
                        <tr>
                            ...
                            <td>
                               <div><asp:CheckBox ID="chkstatus" runat="server" Visible="True" CssClass="CsCheckBox" Text="Chọn: kích hoạt" /></div> 
                                ...
                                <div><asp:CheckBox ID="CheckBox1"   runat="server" CssClass="CsCheckBox" Text="Trang chủ - Tư Vấn" /></div> 
                                <div><asp:CheckBox ID="CheckBox2"   runat="server" CssClass="CsCheckBox" Text="Trang chủ - Phong Thủy " /></div> 
