<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExecuteSQL.aspx.cs" Inherits="VS.ECommerce_MVC.cms.View.ExecuteSQL" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="list_item" style="width: 900px; margin: auto">
            ...
            <asp:TextBox ID="txtSQLQuery" TextMode="MultiLine" style=" width:500px; height:500px" runat="server"></asp:TextBox>
                  <br />
                <br /> <asp:Button ID="Button3" runat="server" Text="Ghi File SQLQuery.sql" OnClick="Button3_Click" />
