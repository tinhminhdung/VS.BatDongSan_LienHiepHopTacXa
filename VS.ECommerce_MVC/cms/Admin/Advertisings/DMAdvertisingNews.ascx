<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DMAdvertisingNews.ascx.cs" Inherits="VS.ECommerce_MVC.cms.Admin.Advertisings.DMAdvertisingNews" %>
    ...
    <div id="">
        <div class="Block Breadcrumb ui-widget-content ui-corner-top ui-corner-bottom" id="Breadcrumb">
            <ul>
                ...
                <li class="Last"><span>Danh sách quảng cáo theo nhóm tin tức</span></li>
            </ul>
        </div>
                        ...
                        <div class="span12">
                            <div class="widget">
                                <div class="widget-title">
                                    <h4><i class="icon-reorder"></i>Danh sách quảng cáo theo nhóm  tin tức</h4>
                                </div>
                                        ...
                                        <div class='frm-add'>
                                            <table id="tblinput" border="0" cellpadding="1" cellspacing="0" class="all" width="100%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td></td>
                                                    <td>
                                                        <asp:TextBox ID="txtmota" runat="server" Width="446px" Height="101px" TextMode="MultiLine"></asp:TextBox><span style="font-size: 7pt; color: dimgray"><em></em></span></td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td></td>
                                                    <td>
                                                        <asp:TextBox ID="txtwidth" runat="server" Width="45px">1</asp:TextBox>pxCao<asp:TextBox ID="txtheight" runat="server" Width="45px">1</asp:TextBox>px (Default 0px) <span style="font-size: 7pt; color: dimgray"><em>((Để 0 px sẽ hiển thị kích thước thật của ảnh) - Sau khi chọn vị trí quảng cáo, Chép lại chiều cao và rộng vào ô)</em></span>
                                                    </td>
                                                </tr>
