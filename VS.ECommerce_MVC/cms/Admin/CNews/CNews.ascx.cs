...
namespace VS.ECommerce_MVC.cms.Admin.M_News
{
    public partial class CNews : System.Web.UI.UserControl
    {
        ...
        public void LoadItems()
        {
            ...
            List<Entity.Menu> dt = SMenu.CATEGORY_PHANTRANG(More.NS, (pages - 1), ref Tongsobanghi, Tongsotrang);
            //if (dt.Count >= 1)
            {
            ...
            ltpage.Text = Commond.PhantrangAdmin("/admin.aspx?u=news&su=news", Tongsobanghi, pages);
        ...
        protected void ddlCaps_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                string sss = More.Level_ID(ddlCap.SelectedValue, More.NS);
        ...
        protected void bntcapnhat_Click(object sender, EventArgs e)
        {
            for (int i = 0; i < rp_pagelist.Items.Count; i++)
            {
                ...
                {
                    SMenu.Name_Text("UPDATE [Menu] SET Orders=" + txtOrders.Text + " WHERE ID=" + id.Value + " and capp='" + More.NS + "'");
