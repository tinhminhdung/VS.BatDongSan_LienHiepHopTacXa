<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MAlbum.ascx.cs" Inherits="VS.ECommerce_MVC.cms.Admin.Album.MAlbum" %>
                                                ...
                                                <ItemTemplate>
                                                    <tr>
                                                        ...
                                                        <td style="text-align: center;" class="Imgsmall">
                                                            <a title="<%#Eval("Title")%>" target="_blank" href="/album/<%#Eval("TangName")%>.html"><%#MoreAll.MoreImage.Image(Eval("ImagesSmall").ToString())%></a>
                                                        </td>
                                                        <td>
